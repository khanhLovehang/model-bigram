...
class BigramLanguageModel:
    ...
    def __init__(self):
        self.unigrams = defaultdict(int) # one items
        self.bigrams = defaultdict(int) # two items
        self.vocab = set() # từ vựng
    ...
    def sentence_probability(self, sentence):
        ...
        for i in range(len(tokens) - 1):
            prob *= self.bigram_prob(tokens[i], tokens[i+1])
...
"Tin xã hội 7/18.",
"Sa Pa Lào Cai: Dân tố chính quyền thu hồi đất, đền bù không thỏa đáng.",
"Bán xe không phải thông báo với công an từ 12/2/2018.",
"Tài xế treo băng rôn 'cầu cứu' khi qua trạm BOT Cần Thơ - Phụng Hiệp.",
"Từ 12/2: Bán xe không phải thông báo với công an.",
"Thủ môn Bùi Tiến Dũng nhận thêm 'tin dữ' từ FLC Thanh Hóa.",
"Về quê ăn chạp họ cuối năm, cả 4 người trong gia đình đuối nước thương tâm.",
"Chân dung phi công Nga bị quân khủng bố sát hại.",
"Nhà vô địch SEA Games một mình chống chọi bệnh ung thư kêu cứu.",
"Tuyên án PVP Land: Trịnh Xuân Thanh lãnh án chung thân.",
"Tuyệt vời, ngày tri ân đầy nước mắt và ý nghĩa cho U23 Việt Nam!.",
"Không thể tin nổi độ lầy và lăng nhăng của 'quý phi' Hà Đức Chinh trên sân Thống Nhất.",
"Lộ mức lương của thủ thành Bùi Tiến Dũng tại FLC Thanh Hóa.",
"Ngôi mộ cổ hàng nghìn năm của 'công chúa Ai Cập'.",
"Bạn muốn hẹn hò: Cô nàng muốn 'hướng dẫn' bạn trai khi yêu vì kinh nghiệm tình trường nhiều hơn.",
"Cảm động khoảnh khắc chú chó chạy theo xe hoa 6km để tiễn cô chủ về nhà chồng.",
"Chân dung MC xinh đẹp nói tiếng Anh như gió trong buổi trò chuyện với cầu thủ Xuân Trường.",
"Lệ Quyên nói gì về tin đồn kiếm khoảng 68 tỷ đồng một năm?.",
"Phú Yên: Điều tra hàng loạt quan chức tiếp tay phá rừng.",
"Còn hạn chế trong chấp hành các quy định của pháp luật về thuế.",
"Quyền lực của ông trùm xã hội đen (Kỳ 3): Bi kịch gia đình.",
"Samsung Display Việt Nam kiến nghị hợp nhất 3 giai đoạn đầu tư, Bộ Tài chính nói gì?.",
"Nên công bằng thuế thu nhập.",
...
"Nhiều chính sách quan trọng có hiệu lực thi hành từ tháng 2-2018.",
"Những chính sách mới có hiệu lực từ tháng 2/2018.",
"VFF không can thiệp, U23 Việt Nam tự chia 29 tỷ tiền thưởng trước Tết.",
"U23 Việt Nam được 'tự xử' tiền thưởng, vẫn phải đóng thuế thu nhập.",
"U23 Việt Nam sẽ tự chia hơn 20 tỷ tiền thưởng sau thành tích tại U23 châu Á?.",
"8 chính sách nổi bật có hiệu lực từ tháng 2/2018.",
"Chính sách mới có hiệu lực trong tháng 2-2018 (Phần 1).",
"U23 Việt Nam nhận thưởng 'khủng' nhưng không phải nộp thuế TNCN.",
"Đừng để thành công hôm nay là thành công sau cuối.",
"Tổng cục Thuế: Không thu thuế tiền thưởng diện quà tặng cho cầu thủ U23 Việt Nam.",
"Nhận thưởng kỷ lục, U23 Việt Nam không phải nộp thuế thu nhập cá nhân.",
"VFF chưa nhận được hết tiền thưởng các Mạnh Thường Quân hứa tặng U23 Việt Nam.",
"U23 Việt Nam được thưởng nhiều gấp 3 lần vô địch AFF Cup 2008.",
"Thuế suất nào áp dụng cho nhà đầu tư ngoại.",
"Tiền thưởng U23 Việt Nam vượt mốc 23 tỷ đồng.",
"Tiền thưởng cho U23 Việt Nam vượt mốc 1 triệu USD.",
"Tính thuế thu nhập cá nhân: Giảm thất thu, trốn thuế hơn tăng thuế.",
"Ngắm ngôi làng Italy đẹp như tranh với giá nhà chỉ 1 euro.",
"Đội tuyển U23 Việt Nam phải nộp thuế thu nhập bao nhiêu?.",
"Ngôi làng Italy rao bán nhà chỉ 1 USD để tăng dân số.",
"Tăng chi phí doanh nghiệp: Có thực sự đáng lo?.",
"Đón nhận 'cơn mưa' tiền thường, các cầu thủ U23 Việt Nam sẽ nộp thuế như thế nào?.",
"Mua nhà với giá rẻ hơn 1 cốc cà phê tại Italy.",
"Thị trấn xinh đẹp ở Italy rao bán 200 căn nhà với giá một bảng.",
"Thủ tục chuyển nhượng căn hộ chung cư.",
"Xổ số Vietlott: Chủ nhân tờ vé số phát hành tại Cần Thơ vẫn chưa đến lĩnh thưởng 105 tỷ đồng.",
"Sửng sốt thị trấn ở Italia rao bán hàng trăm căn nhà giá chỉ hơn 27 nghìn đồng.",
"'Cá' hay 'cần câu'?.",
"Thị trấn Ý rao bán hàng trăm căn nhà với giá vỏn vẹn 1 USD.",
"Việt Nam nên đổi 'văn hóa đóng thuế'.",
"Đừng để doanh nghiệp phải mò mẫm trong tiến trình 'xã hội hóa'.",
"Thị trấn ở Ý rao bán 200 căn nhà với giá chỉ hơn 1 USD.",
"Xử lý phản ánh kiến nghị của người dân trong lĩnh vực thuế và hải quan.",
"Thị trấn Ý rao bán nhà giá...,1 USD.",
"Giải đáp tiền bồi thường do vi phạm hợp đồng mua bán căn hộ.",
"Các đặc khu kinh tế sẽ được ưu đãi một loạt sắc thuế.",
"Gỡ vướng quy định về hạch toán chi phí chênh lệch giữa giá mua vàng, ngoại tệ.",
"Người Việt trên 21 tuổi cần yêu cầu nào để vào chơi casino?.",
"Người Việt có thu nhập bao nhiêu mỗi tháng có thể chơi casino?.",
...
"Ưu đãi thuế cho DNNVV: Giảm sức nặng lên 'xương sống' của nền kinh tế.",
"Lâu ngày không chụp hình bikini, Ngọc Trinh bất ngờ tái xuất đầy lợi hại.",
"Thiên nga bơi sát bờ Hồ Gươm, người dân thích thú ngắm nhìn.",
"Đây là cách trị mụn và làm trắng da 'rẻ bèo' đón Tết của cô gái trẻ, con gái ơi phải thử ngay thôi!.",
"MC Thiên Vũ: Dẫn dắt giao lưu đội tuyển U23 Việt Nam tại TP.HCM là một trải nghiệm khó quên.",
"Làng Italy rao bán nhà giá 1,25 USD.",
"Thị trấn miền quê nước Ý rao bán nhà giá 1 USD để hút cư dân.",
"30 điểm đến tự nhiên giàu màu sắc nhất trên thế giới, bạn đã đi được những đâu?.",
"(Phần 1).",
"Thị trấn biển Italy rao bán hàng trăm căn nhà với giá 1 USD.",
"Ngắm những chiếc Rolls-Royce Bespoke đỉnh cao trong năm 2017.",
...
"Hàng chục người đang làm việc ngoài đồng bị sét đánh chết.",
"Một nửa thủ đô Rome của Italy thiếu nước sinh hoạt.",
"MU - Mourinho mua tiền đạo: Vì sao Morata là thượng sách?.",
"Chung kết cúp C1 Real Juventus: Ronaldo bồ đẻ sinh đôi, nhận danh vị số 1.",
"Thực phẩm cho tim và não khỏe.",
"Bắc Quang (Hà Giang): Dân mòn mỏi mong đường tiếp tục được làm.",
...
"Việt Nam sẽ sớm chấm dứt tình trạng nuôi nhốt gấu.",
"'Hóa giải' bất cập về lắp đặt bó vỉa hè ở thành phố Hà Tĩnh.",
"Từ Bến Tre ra Nghệ An nhận lại xe máy bị mất trộm 1 năm trước.",
"Chủ hộ kinh doanh cá thể có đóng BHXH bắt buộc?.",
"Thầy trò chạy nước rút cho kỳ thi THPT.",
"Không đóng bảo hiểm, công ty thua kiện công nhân.",
"Nhóm học sinh tự nguyện dọn rác ở sân Thống Nhất.",
...
"TAND huyện Đông Anh, Hà Nội: Điểm sáng về công tác thiện nguyện.",
"Giang Hồng Ngọc nói về mối tình mất lý trí: 'Tôi yêu ngu quá'.",
"Thành lập Hội bảo vệ động vật Việt Nam.",
"Mỹ nữ Lào Cai nhảy nhạc T-ara gây bão Facebook làm nhiều chàng trai buồn lòng.",
"ĐÀN BÀ có thể hy sinh mọi thứ, miễn là cho người xứng đáng!.",
"Tặng thưởng U23 Việt Nam 'đã nói là phải làm'.",
"Clip: Mercedes tạt đầu container và cái kết như phim hành động.",
"Thương Tín một đời lẫy lừng tình ái, về già lận đận với con thơ.",
"Tranh chấp thương mại: Vì sao nên chọn hòa giải?.",
"4 lý do khiến Venezuela trở thành nền kinh tế tồi tệ nhất thế giới.",
"Việt Nam sẽ sớm chấm dứt tình trạng nuôi nhốt gấu lấy mật.",
"Phát hiện cơ sở chế biến phụ phẩm heo bẩn tại TP.HCM.",
"Bác sĩ 'yêu râu xanh' có thể sẽ lãnh án 300 năm tù vì lạm dụng 265 nạn nhân.",
"Tự kỷ chỉ nên là một mảnh ghép nhẹ nhàng.",
"Phải xem đại học tư thục là doanh nghiệp.",
"Thật khó lường.",
"Kinh nghiệm quản lý hoạt động nuôi, nhốt gấu và bảo tồn gấu trong tự nhiên.",
"Nhiều hợp đồng 'bẫy' người mua ô tô, khách hàng cần làm gì để tránh?.",
"Google và Uber đưa nhau ra tòa do cáo buộc đánh cắp bí mật thương mại.",
"Hứa thưởng U23 Việt Nam - chậm thì phải nhắc.",
"Nơi phụ nữ biến thành đàn ông, phải giữ trinh tiết trọn đời.",
"Huế ồ ạt cấp phù hiệu, Đà Nẵng căng sức 'dọn' xe trá hình.",
"Bộ Tài chính nói gì về việc Mai Linh xin khoanh nợ, giãn nợ?.",
"Tiền thưởng cho U23 Việt Nam: Sẽ thông tin chính thức.",
"Vì sao 'yêu râu xanh' có thể lộng hành?.",
"Suy ngẫm về lòng tốt...",
"Câu chuyện thể thao: Phía sau bản hợp đồng 'ồn ào' của thủ môn U23 Việt Nam.",
"Trà Vinh: Kỷ luật chánh án vì..., thường 'nhắn tin' cho nữ thư ký tòa.",
"Bộ trưởng Mai Tiến Dũng: 'Nhắc nhở các doanh nghiệp hoàn thành tiền thưởng cho U23 Việt Nam'.",
"Trường mẫu giáo cô lập trẻ không học Aerobic trong giờ chính khóa.",
"SỐC: Nạn nhân của bác sĩ 'yêu râu xanh' lên đến hơn 265 phụ nữ.",
"Y án đối tượng cùng em trai 'trả nợ' bằng 1 xô nước!.",
"Trẻ thiệt thòi vì không được làm giấy khai sinh.",
"Bộ trưởng Mai Tiến Dũng: 'Đã nói là phải làm' với lời hứa tiền thưởng cho U23 Việt Nam.",
"Bác sĩ trị liệu lạm dụng tình dục hơn 260 phụ nữ.",
"Vì nhân dân mà chiến đấu.",
"U23 Việt Nam nợ bầu Hiển một lời cảm ơn.",
"DANH DỰ ĐẢNG VIÊN.",
"Cô gái 16 tuổi chết đói, cảnh sát điều tra phát hiện dòng chữ rợn người 'không mở cửa sổ được đâu, mẹ đã đóng đinh rồi'.",
"Những chính sách mới về kinh tế có hiệu lực kể từ tháng 2/2018.",
"Công dân Triều Tiên gặp người Mỹ trước khi bị sát hại ở Malaysia.",
"Xét xử Đoàn Thị Hương: Kim Chol gặp một người Mỹ trước khi bị sát hại.",
"Châu Á: Hơn 20.000 cá thể gấu nuôi nhốt để lấy mật.",
"Người vái xin HĐXX tiếp tục xét xử để được minh oan.",
"Bộ trưởng Mai Tiến Dũng: Ai đã nói thưởng U23 Việt Nam phải làm ngay.",
"Toàn bộ lãnh đạo Liên đoàn Thể dục dụng cụ Mỹ từ chức vì bê bối lạm dụng tình dục.",
"Chẳng ai yêu mãi được một người, quan trọng ai sẽ vì mình mà ở lại.",
"TP Điện Biên Phủ: Kế toán Trung tâm bồi dưỡng chính trị bị điều xuống làm..., lao công.",
"Sẽ công bố chính thức việc chi thưởng cho Đội tuyển U23 Việt Nam.",
"Lâm Đồng:Bị thu hồi đất, dân nghèo ngơ ngác vác đơn cầu cứu khắp nơi.",
"Các đơn vị đã hứa thưởng U23 Việt Nam thì phải làm.",
"Đội câu Kiều đi suốt Trường Sơn tìm chồng.",
"'Nóng' vấn đề tiền thưởng và việc Vietjet đón U23 Việt Nam tại họp báo Chính phủ.",
"Có được từ chối ra tòa làm nhân chứng?.",
"Họp báo Chính phủ: Không 'sốt ruột' chuyện hứa thưởng cho U23 Việt Nam.",
"Cựu Tổng thống Brazil bị cáo buộc tham nhũng khi sở hữu căn hộ cao cấp bên bờ biển.",
"Tổng thống Brazil đối mặt những cáo buộc mới.",
"Tặng thưởng U23 Việt Nam, các tổ chức, cá nhân 'đã nói là phải làm'.",
"4 đối tượng 'cướp' xe khách ở Gia Lai ra trình diện.",
"Tiền thưởng cho U23 Việt Nam: Đã nói là phải làm!.",
"Rúng động nước Mỹ vụ bác sĩ 'yêu râu xanh' hại đời 160 phụ nữ.",
"Phiên tòa bê bối lạm dụng tình dục ở thể thao Mỹ tiếp tục gợi lên nhiều nỗi đau.",
"Tòa án Malaysia tiếp tục xét xử Đoàn Thị Hương.",
"Những kẻ buôn xác người: Bào thai bí ẩn trong nhà kho.",
"Phiên xử Đoàn Thị Hương tiếp tục, luật sư chỉ trích tòa 'quá đơn giản'.",
"Vẫn là vấn nạn xe dù.",
...
"57 cán bộ Sở thất lạc bằng cấp 3: 'Không lớn lắm'.",
"Những màn cầu hôn nổi tiếng trước đám đông của sao châu Á.",
"Mắc bệnh 'nhà giàu', đại gia gặp khó tại phiên tòa Phạm Công Danh.",
"Chiến lược quân sự mới Mỹ đặt Trung Quốc, Nga vào 'vòng ngắm'.",
"Phiên tòa xử Đoàn Thị Hương sẽ tiếp tục trong tuần tới.",
"Italia phát hiện 8 người di cư thiệt mạng trên biển.",
"Di cư và bi kịch nối dài.",
"Lật thuyền di cư, 26 phụ nữ Nigeria chết đuối.",
"Kỳ quặc nhà hàng khuyến khích khách cởi bỏ quần áo.",
"Thứ trưởng Lê Quang Hùng kiểm tra để nghiệm thu kỹ thuật xây dựng công trình đường cao tốc Hạ Long - Vân Đồn.",
"Quảng Ninh: Quốc lộ 18 đoạn Hạ Long - Mông Dương đã 'lột xác' thế nào?.",
"Cận cảnh 'con đường đau khổ' QL18 hồi sinh.",
"Câu chuyện 60 năm của BIDV Hải Dương (Kỳ 1).",
"Dự án nâng cấp QL18 Hạ Long-Mông Dương tạo nên không gian đô thị mới.",
"Thử thu phí dự án nâng cấp và cải tạo quốc lộ 8 đoạn Hạ Long Mông Dương.",
"QL 18 tuyến Hạ Long-Mông Dương thay áo mới sau khi đầu tư nghìn tỷ.",
"Cẩm Phả: Diện mạo mới cho quốc lộ 18.",
"Cận cảnh tuyến đường nghìn tỷ QL 18 đoạn Hạ Long - Mông Dương.",
"Quảng Ninh 'gỡ' nút thắt hạ tầng giao thông nhờ dự án BOT.",
"Thử nghiệm thu phí tại QL18 đoạn Hạ Long Mông Dương.",
"BOT Hạ Long - Mông Dương giảm giá vé cho người dân Cẩm Phả.",
"Vận hành thử nghiệm trạm thu phí BOT trên QL18, đoạn Hạ Long - Mông Dương.",
"BOT Hạ Long - Mông Dương: Thu phí thử nghiệm.",
"Vận hành thử nghiệm trạm thu giá BOT trên quốc lộ 18, đoạn Hạ Long Mông Dương.",
"Ứng xử để không xảy ra 'điểm nóng' BOT.",
"Công ty CP đường sắt Hà Thái: 20 năm xây dựng và phát triển.",
"Genco3 hưởng lợi lớn khi CGM và WCM đi vào vận hành.",
...
"Cơ hội đầu tư vào cổ phần Tổng công ty Phát điện 3.",
"Đôt phá thu hút vốn tư nhân vào hạ tầng.",
"Tiết xuân nhớ về tiên công dựng làng thợ mỏ.",
"Miễn, giảm phí cho người dân sống gần trạm BOT QL18.",
"Thêm một trạm BOT tại Quảng Ninh miễn phí cho người dân lân cận.",
...
"Hàng nghìn tỉ đồng đầu tư đang 'ùn ùn' đổ về đặc khu kinh tế Vân Đồn.",
"Loạt siêu dự án triệu đô tại khu kinh tế Vân Đồn.",
"Vận chuyển hơn 10kg pháo nổ trên xe khách.",
"Bắt giữ nam thanh niên giấu 10 hộp pháo giàn trong cốp xe.",
...
"Quảng Ninh: Người dân sống chung với ô nhiễm từ nhà máy chế biến quặng antimon?.",
...
"Bắc Ninh: Nâng cao chất lượng chương trình xây dựng nông thôn mới.",
...
"Bộ Xây dựng cho ý kiến về Trung tâm dịch vụ du lịch Hàm Tiến Mũi Né.",
...
"Niềm tin trong thông điệp liên bang đầu tiên của Tổng thống Trump.",
...
"Thủ tướng: Cố gắng đưa VN thành 'con hổ mới' của nền kinh tế châu Á.",
"Ireland trưng cầu ý dân về thay đổi luật cấm phá thai.",
...
"Đề nghị dừng trao bán ngay lập tức 2 dự án tại tỉnh Long An.",
...
"HongKong Tower: Bí ẩn tài sản đảm bảo giữa CĐT và ngân hàng NCB.",
...
"Vấn đề Brexit: Hàng nghìn người biểu tình kêu gọi chính phủ hỗ trợ Hệ thống y tế công.",
...
"Bộ Tài chính lên tiếng về kiến nghị thanh tra 62 dự án đất vàng.",
"Bắt khẩn cấp đối tượng tàng trữ gần 2,5 tạ pháo ở Quảng Ninh.",
"Bắt giữ nhiều vụ vận chuyển, buôn bán trái phép pháo nổ.",
...
"Xe trộn bê tông bất ngờ bốc cháy.",
"Ráo riết chặn hàng lậu từ biên giới Quảng Ninh.",
"Những quy định nổi bật có hiệu lực từ tháng 2/2018.",
"BQLDA ĐTXD các công trình giao thông Bắc Giang: Đáp ứng yêu cầu chất lượng và tiến độ.",
"Chưa giảm giá chung cho các phương tiện qua BOT Đại Yên.",
"'Dân vận khéo' ở đảng bộ xã Cẩm Ngọc.",
...
"Quảng Ninh: Trung tu quốc lộ 8 đoạn Hạ Long Uông Bí.",
...
"Khởi tố tài xế giật điện của nhân viên trạm thu vé.",
...
"CSGT Quảng Ninh liên tiếp bắt giữ các đối tượng mang theo ma túy.",
"Đã có Thông tư hướng dẫn Nghị định 116 về nhập khẩu ô tô.",
"Bộ GTVT siết quy định về ô tô nhập khẩu.",
"Chính thức ban hành Thông tư hướng dẫn Nghị định 116 về nhập khẩu ô tô.",
"Mở rộng đường vào đất thiêng Yên Tử.",
...
"Grab âm thầm hoạt động 'chui' tại Bình Định.",
...
"Quảng Ninh: Ôtô lao xuống vực, 4 người nước ngoài bị thương.",
...
"Rủi ro khi mua bán qua tay nhà ở xã hội.",
...
"Hàn Du - Mỹ nhân mang tiếng mặt dày khi ngoại tình còn ngang nhiên đuổi chồng ra khỏi nhà.",
...
"Làm thế nào khi bị mất giấy tờ hoàn công?.",
...
"Chuyển quyền sử dụng đất từ cá nhân sang tài sản công ty.",
"Đền bù khi thu hồi đất trồng cây lâu năm.",
"Ép bạn gái phải cưới vì đã có con chung.",
"Chuyển quyền sử dụng khi mua bán nhà đất.",
...
"Tổng cục hướng dẫn vụ '1 mảnh đất, 2 tòa cùng quyết'.",
...
"TP.HCM: Ở nhờ còn ngụy tạo hồ sơ chiếm đoạt nhà đất?.",
...
"Tá hỏa phát hiện 'người lạ' sở hữu nhà mình.",
...
"Có khuất tất trong vụ Ngân hàng NCB bán đấu giá tài sản 'khủng' đang tranh chấp?.",
...
"Tập trung xử lý các cơ sở sản xuất, khu vực gây ô nhiễm môi trường.",
"Dấu ấn từ vỉa hè đô thị.",
"1.400 tỉ làm nghĩa trang cho cán bộ cấp cao, danh nhân.",
"Đồng chí Bí thư Tỉnh ủy, Chủ tịch HĐND tỉnh kiểm tra tình hình sản xuất và đời sống nhân dân huyện Quảng Xương.",
"Bình Dương công bố quyết định của Thủ tướng công nhận Thủ Dầu Một là đô thị loại I.",
...
"Người mẹ 9 năm đi đòi quyền lợi cho con gái.",
...
"Người miền Tây.",
"Cái kết 'nghẹn' cho anh chàng 'kén cá chọn canh', gặp cô nào cũng chê ỉ chê ôi.",
...
"Ông lão 'soái ca' dựng cả khu vườn tình yêu bên mộ vợ.",
...
"Xử lí trách nhiệm người đứng đầu tại Đảng bộ bộ phận Thanh tra giao thông TP Cần Thơ.",
...
"Đề nghị giảm giá vé cho 1.148 phương tiện qua Trạm T1&T2.",
"Miễn giảm thu phí các xe xung quanh trạm BOT Cần Thơ Phụng Hiệp.",
...
"Thương hiệu hoa- sản phẩm du lịch riêng có của Hoành Bồ.",
...
"Tưng bừng khai mạc lễ hội hoa giữa lòng di sản Hạ Long.",
...
"Tai nạn liên hoàn gây ách tắc giao thông trên Quốc lộ 18A.",
...
"Vận chuyển trái phép gần 500m³ cát trái phép.",
...
"Ông Park Hang Seo có thể có thêm quốc tịch Việt Nam nếu được Chủ tịch nước cho phép.",
...
"Nông sản có chỉ dẫn địa lý chật vật không thể xuất khẩu.",
"Mê hoặc áo dài họa tiết hoa mùa Xuân của thời trang HT.",
...
"Triệt phá đường dây, ổ nhóm mua bán, tàng trữ trái phép ma túy.",
...
"90% doanh nghiệp áp dụng Chữ ký số trong kê khai thuế.",
"Nữ quái 'chuyên' tìm địa điểm tổ chức ổ bạc đánh lốc.",
"Song Joong Ki từ chối tiệc về nhà khi hết sự kiện, dân mạng đồn Song Hye Kyo có bầu.",
"Cấm xe khách sang đảo Cát Bà: Sao cơ quan quản lý không lấy ý kiến người dân?.",
...
"Tháng 1: Lợi tức trái phiếu lần đầu xuống dưới 3%, lãi suất liên ngân hàng đột biến do cục bộ.",
"Cặp đôi Titanic 'song kiếm hợp bích' đưa người trở về từ cõi chết.",
"Kết quả đấu giá cổ phần Vinacomin.",
"Thông báo IPO Viện Dệt May.",
...
"'Di sản' cổ phần hóa thời ông Đinh La Thăng làm bộ trưởng: Nhìn lại hồ sơ Công ty Phục vụ Mặt đất Sài Gòn.",
...
"IPO 'ông lớn' xuất khẩu gạo Vinafood 2 vào 14/3.",
"Giữ lửa nhiệt huyết, sẻ chia yêu thương tại Gala chào Xuân 2018.",
"Đêm nhạc thiện nguyện 'Món quà xuân cho em'.",
...
"Tập đoàn Cao su 'ế' nặng trong đợt IPO 6.000 tỉ đồng.",
"Góc tối thị trường đấu giá tác phẩm nghệ thuật.",
"Tập đoàn cao su chỉ bán được 20% lượng cổ phần IPO.",
"Phu nhân Đại sứ Haiti diện áo dài diễn thời trang.",
"IPO Tập đoàn Công nghiệp Cao su thu về hơn 1300 tỷ đồng.",
"Nhà đầu tư tranh mua cổ phần Seabank, gấp đôi lượng chào bán.",
"Phu Nhân Đại sứ Haiti sải bước tự tin trên sàn catwalk Việt.",
"Tập đoàn Công nghiệp Cao su Việt Nam chỉ bán được 1/4 khối lượng cổ phần IPO.",
...
"Phát triển quan hệ Việt Nam - Cameroon lên tầm cao mới.",
"Khi Thu Trang từ 'Hoa hậu hài' chuyển sang làm..., má mì.",
"Con gái cụ bà ôm chặt cụ ông trên giường bệnh gây 'bão' mạng: 'Có người nói tôi ghép ảnh câu like'.",
"Ảnh cụ bà ôm người bạn đời bị bệnh từ phía sau lay động dân mạng.",
"Xúc động hình ảnh cụ bà ôm chặt cụ ông trên giường bệnh.",
...
"Đồng hành và chia sẻ: Chương trình thiết thực vì nông dân.",
"Khám phá khu mộ cổ nguy nga tại Tây Đô.",
"Chàng trai Khánh Hòa tỏ tình bằng bản thiết kế ngôi nhà tương lai.",
"Tổng Bí thư, Chủ tịch Trung Quốc Tập Cận Bình viếng Lăng Chủ tịch Hồ Chí Minh.",
"Nhìn lại chuyến thăm Việt Nam của Tổng thống Trump.",
"Báo Hong Kong đăng tải đậm nét về quan hệ Việt Nam-Trung Quốc.",
"Truy tìm kẻ gây tai nạn còn đánh người.",
"Cản trở cơ quan công an xử lý xe vi phạm.",
...
"Điều tra vụ đầu độc hàng trăm cây thông bằng thuốc diệt cỏ.",
...
"'Hội phụ huynh' của VFF, không hiệu quả thì dẹp bỏ!.",
"Nứt đất kinh hoàng lên 20ha, dân vớt vát tài sản tháo chạy.",
"Bằng cấp thật - bằng cấp..., rởm.",
"Nứt đất bất thường, hàng chục ha cà phê bị vùi lấp.",
"Kinh hãi, nứt đất khiến 10ha cà phê bị hư hỏng.",
"Nhìn lại những hình ảnh xót lòng nơi siêu bão quét qua.",
"Lâm Đồng: Hơn 3 năm chưa thi công xong đường, dân rút tiền tự làm.",
"Đồ Sơn 'thất thủ', Nam Định sóng đánh vào tận nhà.",
"Quản lý cư trú, cấp hộ chiếu qua mạng: Dân hài lòng, 'cò mồi' giải tán!.",
"Lâm Đồng: Mất đất vì cho mượn?.",
"Nhiều nước gửi điện mừng kỷ niệm 72 năm Quốc khánh Việt Nam.",
"Báo GĐ&XH;, Hội đồng hương Hà Tĩnh tiếp tục kêu gọi ủng hộ đồng bào vùng lũ Hà Tĩnh.",
...
"Xử phạt doanh nghiệp ngang nhiên lấp sông Ba làm đường chở cát.",
"Giáo viên cấu kết nhân viên y tế trường học bán đề thi giả.",
"Bắt nữ giáo viên mầm non rao bán đề thi viên chức giả.",
"Những gã tài xế bất lương.",
"Lấp sông trái phép để chở cát.",
"Bắt 2 nữ giáo viên nghi bán đề thi giả.",
"Sạt lở đất bất thường ở Lâm Đồng nghi do đào vàng trái phép?.",
"Doanh nghiệp ngang nhiên ngăn sông Ba làm đường chở cát.",
"Bắt cô giáo bán đề thi viên chức giả giá 40 triệu.",
"Doanh nghiệp ngang nhiên ngăn sông làm đường chở cát ở Phú Yên.",
"Dự án di dân khẩn cấp ở Nam Định.",
"Bắt hai giáo viên bán đề thi công chức giả.",
"Được giao đất chỉ để..., ngắm!.",
"7 đội bóng mạnh nhất tranh tài tại Vòng chung kết Press Cup 2017.",
"Hết đào đường, DaLat Hasfarm lại lập Barie trái phép chặn đường.",
"Kỷ niệm 30 năm thành lập huyện kinh tế mới Hà Nội trên đất Lâm Đồng.",
"Thường Tín (Tp.Hà Nội): Dân kêu trời vì bãi tập kết vật liệu xây dựng 'lấn chiếm', gây ô nhiễm môi trường?.",
"FC Báo chí Thanh Hóa: Xuất quân tham dự vòng chung kết Giải bóng đá Press Cup 2017.",
"'Hơn 40 năm rồi Hà Nội vẫn không quên chúng tôi'.",
"Bắt đối tượng nghiện ma túy trộm cắp tài sản công dân.",
"Hà Nội tiếp tục hỗ trợ phát triển huyện Lâm Hà - tỉnh Lâm Đồng.",
"Lật tẩy thủ đoạn 'hồn Trương Ba, da hàng thịt' trong làm hộ chiếu.",
"Campuchia làm ô tô điện từ lâu, VN vẫn tranh cãi.",
"Sụp lở, trượt đất bất thường tại Lâm Đồng vẫn diễn biến phức tạp.",
"Độc đáo thành cổ Diên Khánh.",
"Hiện tượng lạ: Hàng loạt điều hòa ở nhiều chung cư của Hà Nội hỏng.",
"Sạt lở nghiêm trọng tại Lâm Đồng: Chưa xác định nguyên nhân nên không thể áp dụng mức bồi thường.",
"Lâm Đồng: Trộm đột nhập phòng Chủ tịch huyện, lấy cắp máy tính.",
"Cơ chế nào bảo vệ nhà báo tham gia đấu tranh chống tiêu cực?.",
"Trộm đột nhập phòng Chủ tịch UBND huyện lấy tài sản.",
"Chủ tịch nước Trần Đại Quang tiếp Hoàng hậu Vương quốc Hà Lan.",
"Tòa án vô trách nhiệm, dân mòn mỏi đợi chờ trong vô vọng.",
"Trung Quốc bắn 21 phát đại bác chào đón Chủ tịch nước Trần Đại Quang.",
"Hàng chục hộ dân Lâm Đồng có nguy cơ mất nhà do sạt lở.",
"Bé gái không ăn được cơm, chỉ uống nước.",
"Rao bán đề thi công chức giả giá 40 triệu, 2 cô giáo bị bắt.",
"Những vụ chuyển nhượng đất kỳ lạ.",
"Chủ tịch nước thăm và làm việc tại Đại đội 33, Bộ CHQS tỉnh Nghệ An trên Đảo Ngư.",
"Truy tìm kẻ mạo danh, lừa bán đất 3,5 tỷ đồng.",
"Hơn 10 ha đất trồng cà phê ở Lâm Đồng bỗng nhiên bị sụt lún.",
"Đầu tư 543 tỷ đồng xây dựng hạ tầng vùng kinh tế mới Lâm Hà, Lâm Đồng.",
"Truy tìm đối tượng giả mạo người khác, lừa bán đất 3,5 tỷ đồng.",
"Lâm Đồng: Sạt lở đất, hơn 10 ha cà phê đang thu hoạch nguy cơ mất trắng.",
"Truy nã kẻ dùng giấy tờ giả lừa bán nhà đất, chiếm đoạt hàng tỷ đồng.",
"Sụt đất nuốt chửng 10ha cà phê Lâm Đồng: Chưa từng có.",
"Công an truy nã đối tượng lừa bán nhà đất 3,5 tỷ đồng.",
"Hàng trăm cây thông bị 'đầu độc' không thương tiếc.",
"Lâm Đồng: Người dân lo lắng vì sụt lở đất.",
"Lâm Đồng: Tòa án Lâm Hà 'tiếp tay' cho nhiều đối tượng chiếm đoạt đất?.",
"Hà Nội dự kiến hỗ trợ huyện Lâm Hà (Lâm Đồng) 94 tỷ đồng.",
"Lâm Đồng: Diện tích đất sạt lở bất thường ở xã Đạ Đờn ngày càng tăng.",
"Lâm Đồng: Bắt nữ giáo viên rao bán đề thi viên chức giả giá 40 triệu/bộ.",
"Nhiều vi phạm trong quản lý tài nguyên, khoáng sản.",
"'Ninja' đột nhập UBND huyện.",
"Tình trạng nứt, sạt lở đất ở xã Đạ Đờn ngày càng trầm trọng.",
"4.000 m2 rừng Lâm Đồng bị hủy diệt bằng thuốc diệt cỏ.",
"30 ha cà phê bị vùi lấp do sạt lở đất, bà con nông dân hoang mang.",
"Lâm Đồng: Sạt lở làm mất trắng 15 ha cà phê và trên 100 ha bị ảnh hưởng.",
"Suýt bị vợ bỏ vì mê trồng sâm, giờ ung dung 'đút túi' nửa tỷ/năm.",
"Lâm Hà (Lâm Đồng): Xử lý 73 vụ vi phạm Luật Bảo vệ và Phát triển rừng.",
"'Lão nông dở người' thu tiền tỷ từ cây dược liệu.",
"Phật nói: Kiếp trước bạn là người thế nào, vận mệnh kiếp này của bạn ra sao?.",
"Tây Âu và chuyện về chó.",
"Gã bạn trai sở khanh và câu chuyện về lần chuyển khoản nhầm cho bạn gái.",
"Phật chỉ ra nhân duyên kiếp trước của 10 loại người.",
"11 loại nhân duyên kiếp trước và 12 đường nhân quả báo ứng ảnh hưởng trực tiếp đến cuộc đời con người.",
"Truyện hay nên đọc cho con: Hai anh em và con chó đá.",
"Đứa trẻ 8 tháng tuổi và các đại án gây thất thoát.",
"Đời kỳ lạ của tỉ phú không tiền.",
"Kiếm gần 75.000 USD/tháng nhờ ăn xin ở Dubai.",
"Xôn xao vụ cô gái đập nát Iphone X vì mẹ bạn trai đòi quà sau chia tay.",
...
"99 lời Phật dạy về tình yêu, cuộc sống cần khắc cốt ghi tâm.",
"Rước họa vào thân vì Thẩm mỹ viện.",
"Nghiệp báo luôn đeo đuổi cuộc đời mỗi người.",
"Pháp đánh dấu 3 năm sau vụ tấn công tạp chí Charlie Hebdo.",
"Người canh nước.",
"Khách từ TP.HCM ra Vinh đưa tang bà nội, máy bay Vietjet hạ cánh xuống Hà Nội.",
"Ngôi trường tình thương của nhà Phật.",
"Mọi việc trong đời người đều là có nguyên nhân, không có việc gì là vô duyên vô cớ.",
"Hỗn loạn tại BOT Cần Thơ - Phụng Hiệp: Người dừng cố thủ 1 tiếng, kẻ lùi xe chắn ngang quốc lộ.",
"Khổ sở vì góp Tết 3 triệu với nhà nội, mẹ chồng chê ít không lấy.",
"Duyên đến duyên đi, hết thảy đều là phúc.",
"Những thế cầm đũa bạn nên kiêng cử để tránh điềm xấu.",
"Sốc vì Ngọc Trinh phát ngôn chuyện vay - trả tiền đầu năm mới 2018.",
"Gieo trồng thiện duyên.",
"Có nhiều người sinh cùng giờ cùng ngày tháng năm nhưng lại người giàu kẻ nghèo, kẻ sang người hèn?.",
"10 ảnh hot trong ngày trên Facebook (1/1).",
"Tin sao Việt: Hồ Ngọc Hà và Kim Lý mặn nồng ngày nghỉ lễ.",
"Điều phật dạy về hiếu với cha mẹ nghe rất dễ nhưng làm rất khó, sống hiếu sẽ hơn ngàn lần tích đức.",
"Biết nhà chồng là hang hùm đầm hổ, nhưng tôi vẫn phải lao vào vì..., sĩ diện.",
"Steve Jobs và Bill Gates: Mối quan hệ tình thù kỳ thú của làng công nghệ.",
"4 kỳ án động trời trong Tử Cấm Thành.",
"Áo giáp của Bồ tát.",
"Bức xúc với 'hot girl xăm trổ làm từ thiện' tiếp tục tắm trong tiền và phát ngôn gây sốc.",
"Một người nếu ôm giữ lòng cảm ân, người đó sẽ có được mọi thứ.",
"Đức Phật dạy buông bỏ 4 thứ không tồn tại vĩnh cửu trong đời này.",
"Du lịch Đà Lạt, cô gái bị lừa tiền khi chụp ảnh với Pikachu.",
"Du lịch Đà Lạt: Du khách bức xúc vì bị lừa tiền khi chụp ảnh với Pikachu.",
...
"Thay đổi số phận nhờ những việc này.",
"Không còn nghi ngờ gì nữa, 2017 chính xác là năm của BTS.",
"Chuyện nọ xọ chuyện kia.",
"Nhóm cướp tinh vi dàn cảnh cướp xe, ví, điện thoại trong 30 giây.",
"Ăn cơm 2.000, lái Grab, uống trà sữa bị lên án: Sinh viên giờ khổ quá!.",
"Thông tin nhanh qua đường dây nóng.",
"Hậu Giang đưa điện lưới quốc gia về vùng khó khăn.",
"Lập lại trật tự tại các trạm BOT.",
"Vướng mắc khi miễn giảm phí qua BOT Cần Thơ - Phụng Hiệp.",
"Chủ động ứng phó với xâm nhập mặn mùa khô 2018.",
"Miễn, giảm phí qua trạm BOT trên QL1 và 91.",
"UBMTTQ tỉnh Hậu Giang: Thực hiện có hiệu quả công tác bảo vệ môi trường.",
"Dùng tiền lẻ nhúng nước để phản đối ở trạm BOT Cần Thơ Phụng Hiệp.",
"Rà soát phương tiện được miễn, giảm qua 3 trạm BOT.",
"Hôm nay lấy ý kiến người dân về mức giảm phí trạm BOT T1, T2.",
"Tài xế trả tiền lẻ nhưng không dám dừng xe quá 5 phút.",
...
"Nhiều tài xế sử dụng tiền lẻ thấm nước mua vé qua Trạm BOT Cần Thơ Phụng Hiệp.",
"BOT Cần Thơ - Phụng Hiệp lại ùn tắc vì tài xế dùng tiền lẻ qua trạm.",
"Bộ trưởng chỉ đạo làm rõ vụ người mẫu mặc phản cảm trên chuyến bay đón U23.",
"Xả trạm BOT Cần Thơ Phụng Hiệp cổ vũ đội tuyển U23 Việt Nam."]
...
print("P(xế | tài) =", model.bigram_prob("tài", "xế"))
print("P(dùng | tài) =", model.bigram_prob("tài", "dùng"))

# Sentence probability
sentence = "Tài xế bị thu bằng lái"
print("\nSentence probability:", model.sentence_probability(sentence))

# Next syllable prediction
print("\nNext syllable prediction after 'tài':")
for word, prob in model.predict_next("tài"):
    print(word, prob)